			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (textmsp.getText().isEmpty() || texttsp.getText().isEmpty() || textxx.getText().isEmpty()
						...
						JOptionPane.showMessageDialog(null, "Nhập thông tin muốn sửa !");
					} else {
						int x = 0;
						while (rs1.next()) {
						...
						if (x == 0) {
							...
							String query = "Update dbo.QLSP set MaSP='" + textmsp.getText() + "' ,TenSP='"
									+ texttsp.getText() + "' ,XuatXu= '" + textxx.getText() + "'  ,Soluong= '"
									+ textsl.getText() + "' ,Giatien= '" + textgt.getText() + "' where MaSP='"
									+ textmsp.getText() + "'  ";
